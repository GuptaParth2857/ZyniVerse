...
(async () => {
  const searches = [
    ['Bloodhounds_(TV_series)', 'bloodhounds'],
    ['Viral_Hit_(TV_series)', 'viral-hit'],
    ['Kakegurui_(TV_series)', 'bet-kakegurui'],
    ['Kingdom_(film_series)', 'kingdom-5th'],
    ['JoJo%27s_Bizarre_Adventure:_Diamond_Is_Unbreakable_(film)', 'jojo-film'],
    ['Nana_(TV_series)', 'nana-series'],
    ['Your_Name_(2022_film)', 'your-name-la'],
    ['One_Punch_Man_(TV_series)', 'opm-live'],
  ];
