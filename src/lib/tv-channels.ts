...
// Indian TV channel schedules — popular daily programming
// These are typical broadcast schedules for Indian kids' TV channels (IST)
const CN_WEEKLY: Record<string, TimeSlot[]> = {
  Monday: [
    { show: "Shin Chan", start: "06:00", end: "06:30", duration: 30, description: "Daily" },
    { show: "Doraemon", start: "06:30", end: "07:00", duration: 30, description: "Daily" },
    { show: "Oggy and the Cockroaches", start: "07:00", end: "07:30", duration: 30, description: "Daily" },
    { show: "Shin Chan", start: "13:00", end: "13:30", duration: 30, description: "Afternoon" },
    { show: "Doraemon", start: "13:30", end: "14:00", duration: 30, description: "Afternoon" },
    { show: "Ben 10", start: "17:00", end: "17:30", duration: 30, description: "Evening" },
    { show: "Shin Chan", start: "20:00", end: "20:30", duration: 30, description: "Primetime" },
    { show: "Doraemon", start: "20:30", end: "21:00", duration: 30, description: "Primetime" },
  ],
  Tuesday: [
    { show: "Shin Chan", start: "06:00", end: "06:30", duration: 30, description: "Daily" },
    { show: "Doraemon", start: "06:30", end: "07:00", duration: 30, description: "Daily" },
  ...
  Saturday: [
    { show: "Shin Chan", start: "06:00", end: "06:30", duration: 30, description: "Weekend" },
    { show: "Doraemon", start: "06:30", end: "07:00", duration: 30, description: "Weekend" },
    { show: "Oggy and the Cockroaches", start: "07:00", end: "07:30", duration: 30, description: "Weekend" },
    { show: "Ben 10 Marathon", start: "10:00", end: "12:00", duration: 120, description: "Weekend Special" },
    { show: "Shin Chan", start: "13:00", end: "13:30", duration: 30, description: "Afternoon" },
    { show: "Doraemon", start: "13:30", end: "14:00", duration: 30, description: "Afternoon" },
    { show: "Shin Chan", start: "20:00", end: "20:30", duration: 30, description: "Primetime" },
    { show: "Doraemon", start: "20:30", end: "21:00", duration: 30, description: "Primetime" },
...
const SONY_YAY_WEEKLY: Record<string, TimeSlot[]> = {
  Monday: [
    { show: "Taarak Mehta Kya Chhota Chashmah", start: "06:00", end: "06:30", duration: 30, description: "Daily" },
    { show: "Eena Meena Deeka", start: "06:30", end: "07:00", duration: 30, description: "Daily" },
    { show: "Fukrey Boyzzz", start: "07:00", end: "07:30", duration: 30, description: "Daily" },
    { show: "Taarak Mehta Kya Chhota Chashmah", start: "13:00", end: "13:30", duration: 30, description: "Afternoon" },
    { show: "Honey Bunny Ka Jholmaal", start: "13:30", end: "14:00", duration: 30, description: "Afternoon" },
    { show: "Taarak Mehta Kya Chhota Chashmah", start: "20:00", end: "20:30", duration: 30, description: "Primetime" },
    { show: "Fukrey Boyzzz", start: "20:30", end: "21:00", duration: 30, description: "Primetime" },
  ],
  Tuesday: [
    { show: "Taarak Mehta Kya Chhota Chashmah", start: "06:00", end: "06:30", duration: 30, description: "Daily" },
    { show: "Eena Meena Deeka", start: "06:30", end: "07:00", duration: 30, description: "Daily" },
  ...
  Saturday: [
    { show: "Taarak Mehta Kya Chhota Chashmah", start: "06:00", end: "06:30", duration: 30, description: "Weekend" },
    { show: "Eena Meena Deeka", start: "06:30", end: "07:00", duration: 30, description: "Weekend" },
    { show: "Fukrey Boyzzz", start: "07:00", end: "07:30", duration: 30, description: "Weekend" },
    { show: "YAY! Superblock", start: "10:00", end: "12:00", duration: 120, description: "Weekend Special" },
    { show: "Taarak Mehta Kya Chhota Chashmah", start: "20:00", end: "20:30", duration: 30, description: "Primetime" },
    { show: "Fukrey Boyzzz", start: "20:30", end: "21:00", duration: 30, description: "Primetime" },
  ],
  Sunday: [
...
const HUNGAMA_WEEKLY: Record<string, TimeSlot[]> = {
  Monday: [
    { show: "Doraemon", start: "06:00", end: "06:30", duration: 30, description: "Daily" },
    { show: "Shin Chan", start: "06:30", end: "07:00", duration: 30, description: "Daily" },
    { show: "Crayon Shin-chan", start: "07:00", end: "07:30", duration: 30, description: "Daily" },
    { show: "Doraemon", start: "13:00", end: "13:30", duration: 30, description: "Afternoon" },
    { show: "Shin Chan", start: "13:30", end: "14:00", duration: 30, description: "Afternoon" },
    { show: "Doraemon", start: "20:00", end: "20:30", duration: 30, description: "Primetime" },
    { show: "Shin Chan", start: "20:30", end: "21:00", duration: 30, description: "Primetime" },
  ],
  Tuesday: [
    { show: "Doraemon", start: "06:00", end: "06:30", duration: 30, description: "Daily" },
    { show: "Shin Chan", start: "06:30", end: "07:00", duration: 30, description: "Daily" },
  ...
  Saturday: [
    { show: "Doraemon", start: "06:00", end: "06:30", duration: 30, description: "Weekend" },
    { show: "Shin Chan", start: "06:30", end: "07:00", duration: 30, description: "Weekend" },
    { show: "Hungama Super Block", start: "10:00", end: "12:00", duration: 120, description: "Weekend Special" },
    { show: "Doraemon", start: "13:00", end: "13:30", duration: 30, description: "Afternoon" },
    { show: "Shin Chan", start: "13:30", end: "14:00", duration: 30, description: "Afternoon" },
    { show: "Doraemon", start: "20:00", end: "20:30", duration: 30, description: "Primetime" },
    { show: "Shin Chan", start: "20:30", end: "21:00", duration: 30, description: "Primetime" },
...
const NICK_WEEKLY: Record<string, TimeSlot[]> = {
  Monday: [
    { show: "Dora and the Lost City of Gold", start: "06:00", end: "06:30", duration: 30, description: "Daily" },
    { show: "SpongeBob SquarePants", start: "06:30", end: "07:00", duration: 30, description: "Daily" },
    { show: "Motu Patlu", start: "07:00", end: "07:30", duration: 30, description: "Daily" },
    { show: "Rudra: Boom Chik Chik Boom", start: "07:30", end: "08:00", duration: 30, description: "Daily" },
    { show: "Doraemon", start: "13:00", end: "13:30", duration: 30, description: "Afternoon" },
    { show: "Motu Patlu", start: "13:30", end: "14:00", duration: 30, description: "Afternoon" },
    { show: "SpongeBob SquarePants", start: "20:00", end: "20:30", duration: 30, description: "Primetime" },
    { show: "Motu Patlu", start: "20:30", end: "21:00", duration: 30, description: "Primetime" },
  ],
  Tuesday: [
    { show: "Dora and the Lost City of Gold", start: "06:00", end: "06:30", duration: 30, description: "Daily" },
    { show: "SpongeBob SquarePants", start: "06:30", end: "07:00", duration: 30, description: "Daily" },
  ...
  Saturday: [
    { show: "SpongeBob SquarePants", start: "06:00", end: "06:30", duration: 30, description: "Weekend" },
    { show: "Motu Patlu", start: "06:30", end: "07:00", duration: 30, description: "Weekend" },
    { show: "Nickelodeon Superblock", start: "10:00", end: "12:00", duration: 120, description: "Weekend Special" },
    { show: "Doraemon", start: "13:00", end: "13:30", duration: 30, description: "Afternoon" },
    { show: "Motu Patlu", start: "13:30", end: "14:00", duration: 30, description: "Afternoon" },
    { show: "SpongeBob SquarePants", start: "20:00", end: "20:30", duration: 30, description: "Primetime" },
    { show: "Motu Patlu", start: "20:30", end: "21:00", duration: 30, description: "Primetime" },
...
const POGO_WEEKLY: Record<string, TimeSlot[]> = {
  Monday: [
    { show: "Chhota Bheem", start: "06:00", end: "06:30", duration: 30, description: "Daily" },
    { show: "Motu Patlu", start: "06:30", end: "07:00", duration: 30, description: "Daily" },
    { show: "Little Singham", start: "07:00", end: "07:30", duration: 30, description: "Daily" },
    { show: "Chhota Bheem", start: "13:00", end: "13:30", duration: 30, description: "Afternoon" },
    { show: "Motu Patlu", start: "13:30", end: "14:00", duration: 30, description: "Afternoon" },
    { show: "Chhota Bheem", start: "20:00", end: "20:30", duration: 30, description: "Primetime" },
    { show: "Motu Patlu", start: "20:30", end: "21:00", duration: 30, description: "Primetime" },
  ],
  Tuesday: [
    { show: "Chhota Bheem", start: "06:00", end: "06:30", duration: 30, description: "Daily" },
  ...
  Saturday: [
    { show: "Chhota Bheem", start: "06:00", end: "06:30", duration: 30, description: "Weekend" },
    { show: "Motu Patlu", start: "06:30", end: "07:00", duration: 30, description: "Weekend" },
    { show: "POGO Superblock", start: "10:00", end: "12:00", duration: 120, description: "Weekend Special" },
    { show: "Chhota Bheem", start: "13:00", end: "13:30", duration: 30, description: "Afternoon" },
    { show: "Motu Patlu", start: "13:30", end: "14:00", duration: 30, description: "Afternoon" },
    { show: "Chhota Bheem", start: "20:00", end: "20:30", duration: 30, description: "Primetime" },
    { show: "Motu Patlu", start: "20:30", end: "21:00", duration: 30, description: "Primetime" },
...
const NICK_JR_WEEKLY: Record<string, TimeSlot[]> = {
  Monday: [
    { show: "Rusty Rivets", start: "06:00", end: "06:30", duration: 30, description: "Daily" },
    { show: "Shimmer and Shine", start: "06:30", end: "07:00", duration: 30, description: "Daily" },
    { show: "PAW Patrol", start: "07:00", end: "07:30", duration: 30, description: "Daily" },
    { show: "Blaze and the Monster Machines", start: "07:30", end: "08:00", duration: 30, description: "Daily" },
    { show: "PAW Patrol", start: "13:00", end: "13:30", duration: 30, description: "Afternoon" },
    { show: "Rusty Rivets", start: "13:30", end: "14:00", duration: 30, description: "Afternoon" },
    { show: "PAW Patrol", start: "20:00", end: "20:30", duration: 30, description: "Primetime" },
  ],
  Tuesday: [
    { show: "Rusty Rivets", start: "06:00", end: "06:30", duration: 30, description: "Daily" },
    { show: "Shimmer and Shine", start: "06:30", end: "07:00", duration: 30, description: "Daily" },
  ...
  Saturday: [
    { show: "PAW Patrol", start: "06:00", end: "06:30", duration: 30, description: "Weekend" },
    { show: "Shimmer and Shine", start: "06:30", end: "07:00", duration: 30, description: "Weekend" },
    { show: "Nick Jr. Superblock", start: "10:00", end: "12:00", duration: 120, description: "Weekend Special" },
    { show: "PAW Patrol", start: "13:00", end: "13:30", duration: 30, description: "Afternoon" },
    { show: "PAW Patrol", start: "20:00", end: "20:30", duration: 30, description: "Primetime" },
  ],
  Sunday: [
...
// TV channel schedules — hardcoded fallbacks (JioTV API blocked from Vercel IPs)
// Streaming platform schedules also hardcoded here
export const CHANNEL_SCHEDULES: ChannelSchedule[] = [
  // Indian TV channels (hardcoded fallback)
  {
    channelId: "cn",
    schedules: ALL_DAYS.map((d) => ({ day: d, slots: CN_WEEKLY[d] || [] })),
  },
  {
    channelId: "sony_yay",
    schedules: ALL_DAYS.map((d) => ({ day: d, slots: SONY_YAY_WEEKLY[d] || [] })),
  },
  {
    channelId: "hungama",
    schedules: ALL_DAYS.map((d) => ({ day: d, slots: HUNGAMA_WEEKLY[d] || [] })),
  },
  {
    channelId: "nick",
    schedules: ALL_DAYS.map((d) => ({ day: d, slots: NICK_WEEKLY[d] || [] })),
  },
  {
    channelId: "pogo",
    schedules: ALL_DAYS.map((d) => ({ day: d, slots: POGO_WEEKLY[d] || [] })),
  },
  {
    channelId: "nick_jr",
    schedules: ALL_DAYS.map((d) => ({ day: d, slots: NICK_JR_WEEKLY[d] || [] })),
  },
  // Streaming platforms
  {
    channelId: "muse_asia",
