  ...
  return (
    <PageTransition>
      <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6">
        ...
        <div className="flex rounded-2xl border border-[var(--color-line)] bg-[var(--color-panel)] overflow-hidden" style={{ height: "70vh" }}>
          {/* Sidebar */}
          <div className="w-72 sm:w-80 border-r border-[var(--color-line)] flex flex-col shrink-0">
