...
export default function ChallengeCard({ challenge, joined, userProgress, userGoal, index = 0 }: ChallengeCardProps) {
  ...
  return (
    ...
    >
      <Link
        ...
        className="neon-rgb-border no-underline block h-full rounded-xl bg-[var(--color-panel)]/60 backdrop-blur-sm transition-all duration-300"
      >
        <div>
          <div className="p-5">
