      ...
      return (
        <div className="flex min-h-[200px] flex-col items-center justify-center rounded-xl border border-[var(--color-line)] bg-[var(--color-panel)] p-8 text-center">
          ...
          <button
            ...
            className="mt-4 rounded-full border border-[var(--color-cyan)] px-4 py-1.5 text-xs font-semibold text-[var(--color-cyan)] hover:bg-[var(--color-cyan)]/10 transition-all"
          >
            Retry
          </button>
        </div>
